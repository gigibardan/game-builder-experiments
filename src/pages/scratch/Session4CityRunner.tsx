...
const Session4CityRunner = () => {
  ...
  const sections = [
      ...
      content: (
        <>
          ...
          <ImageExample 
            ...
            caption="Exemplu de personaje pentru jocul City Runner"
          />
    ...
    {
      id: 'controlul-pisicii',
      title: 'Controlarea pisicii',
      content: (
        <>
          <p className="mb-4">
    ...
    {
      id: 'animarea-cladirilor',
      title: 'Animarea clădirilor din fundal',
      content: (
        <>
          <p className="mb-4">
    ...
    {
      id: 'linie-margine',
      title: 'Configurarea liniei pentru detecția marginii',
      content: (
        <>
          <p className="mb-4">
